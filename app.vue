...
//   ()=>`https://api.openweathermap.org/data/2.5/weather?q=${search.value}&appid=e4a2009dd8f902daa35cc35a8ff96936`)
...
<template>
  ...
  <div v-else class="p-10">
    <h1 class="text-7xl text-red">Could not find that city!</h1>
    <button class="mt-5 bg-sky-400 px-10 w-50 text0white h-10" @click="goBack">Go back</button>
  </div>
</template>
